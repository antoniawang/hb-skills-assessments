...
class Model(db.Model):
    ...
    def __repr__(self):
        ...
        return "<Brand id=%s year=%s name=%s>" % (
            self.id, self.year, unicode(self.name))
...
class Brand(db.Model):
    ...
    def __repr__(self):
        ...
        return "<Brand id=%s founded=%s headquarters=%s discontinued=%s>" % (
            self.id, self.founded, self.headquarters, self.discontinued)
